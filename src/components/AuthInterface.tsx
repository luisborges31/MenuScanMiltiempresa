      ...
      <form onSubmit={handleAuthSubmit} className="space-y-4">
        ...
        <div className="space-y-3 pt-2">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full py-2.5 px-4 rounded-xl text-xs font-bold text-slate-200 bg-slate-950 border border-slate-800 hover:bg-slate-900 active:scale-95 transition-all flex items-center justify-center gap-2 shadow-sm disabled:opacity-50 disabled:pointer-events-none"
          >
